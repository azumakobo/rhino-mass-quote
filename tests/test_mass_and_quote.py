...
def test_command_registration_doc_has_macros():
    ...
    assert '_-RunPythonScript "/Users/azumakobo/Documents/RhinoScripts/quote_estimate_rhino.py"' in doc
    assert '_-RunPythonScript "/Users/azumakobo/Documents/RhinoScripts/mass_rhino.py"' in doc
